...
$view['slots']->set('headerTitle', $view['translator']->trans('mautic.lead.order.import'));
        ...
        <div class="ml-lg mr-lg mt-md pa-lg">
            <div class="panel panel-info">
                <div class="panel-heading">
                    <div class="panel-title"><?php echo $view['translator']->trans('mautic.lead.order.import'); ?></div>
                </div>
